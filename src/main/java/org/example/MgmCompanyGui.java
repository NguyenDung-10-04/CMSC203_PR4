...
// ==== CHÈN DEBUG Ở ĐÂY ====
    ...
    private Property buildPropertyWithGivenPlot() {
        ...
        try {
            p = new Property(propNameText.getText(), propCityText.getText(), propOwnerText.getText(), Double.parseDouble(propRentText.getText()),
                    Integer.parseInt(propPlotXText.getText()),
